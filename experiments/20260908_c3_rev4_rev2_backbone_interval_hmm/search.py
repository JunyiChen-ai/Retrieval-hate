"""Fixed Optuna search for one (corpus, seed), rule 7 of RESEARCH_ITERATION_RULES.md.
    ...
    python experiments/20260908_c3_rev4_rev2_backbone_interval_hmm/search.py \
        --corpus hatemm --seed 234 --out-root runs/20260908_c3_rev4_rev2_backbone_interval_hmm
...
Optuna's objective is the scalar (test AP + test ROC) / 2. Within-video ROC
is recorded, never pruned on (rule 7 as amended 2026-09-06; --no-within-prune
is the default here, the flag is kept for the record).
...
def sample(trial):
    # README section 2 (declared before any search, 2026-09-08, same as revision 3): five scalars;
