...
RR=runs/20260904_evidence_guided_attention
while [ ! -f runs/20260903_hier_evidence_mil/ablations/CHAIN_hatemm_DONE ]; do sleep 120; done
...
for SEED in 234 2025 3407; do
  ...
  for ABL in avce no_enc evid_audio_only no_cell no_bias scalar_bias no_context no_block no_prior no_cmal mean_prior no_verdict; do
    OUT=$ROOT/$ABL
  ...
  touch $RR/C3_hatemm_seed${SEED}_DONE
done
touch $RR/C3_hatemm_DONE
