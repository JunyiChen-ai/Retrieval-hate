"""One training trial of the evidence-guided cross-modal attention candidate
(candidate 3). Training = candidate 1 (experiments/20260903_hier_evidence_mil)
...
official validation split, test scored through the shared evaluator.
    ...
    python experiments/20260904_evidence_guided_attention/train.py \
...
from model import EGCA, STRUCT_ARMS                    # noqa: E402
...
TRAIN_ARMS = ("mean_prior", "no_block", "no_prior", "no_cmal", "no_verdict")
...
def train(corpus, seed, out_dir, cfg, ablation, device, num_workers):
    ...
    model = EGCA(a, prior_scale, arm=arm, no_verdict=(ablation == "no_verdict")).to(device)
