"""Fixed Optuna search for one (corpus, seed), rule 7 of RESEARCH_ITERATION_RULES.md.
    ...
    python experiments/20260902_verdict_boundary_contrast_mil/search.py \
        --corpus hatemm --seed 234 --out-root runs/20260902_verdict_boundary_contrast_mil
...
def sample(trial):
    return {
        ...
        "lamda_a2b": trial.suggest_float("lamda_a2b", 0.5, 2.0),
        "lamda_a2n": trial.suggest_float("lamda_a2n", 0.5, 2.0),
        "lamda_cof": trial.suggest_float("lamda_cof", 0.02, 0.1),
        "lambda_snico": trial.suggest_float("lambda_snico", 0.05, 2.0, log=True),
