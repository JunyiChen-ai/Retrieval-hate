"""Fixed Optuna search for one (corpus, seed), rule 7 of RESEARCH_ITERATION_RULES.md.
    ...
    python experiments/20260907_c3_rev3_interval_evidence/search.py \
        --corpus hatemm --seed 234 --out-root runs/20260907_c3_rev3_interval_evidence
...
def sample(trial):
    # README section 2 (declared before any search, 2026-09-07): five scalars;
