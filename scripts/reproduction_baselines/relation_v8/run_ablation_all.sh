...
python scripts/reproduction_baselines/relation_v8/property_synthetic_test.py
for corpus in hatemm mhclip_en mhclip_zh hateclipseg; do
  ...
  out="results/reproduction/relation_v8/ablation/${corpus}"
  python scripts/reproduction_baselines/relation_v8/ablation.py \
