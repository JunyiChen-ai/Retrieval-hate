...
SCHEMA_VERSION = "c04_a0t_small_v1_impl_v5"
...
ARTIFACT_ROOT = Path("artifacts/c04/a0t_small_v1_impl_v5")
CONFIG_RELATIVE = "configs/c04/c04_a0t_small_v1_v5.json"
TRAIN_ASR_RELATIVE = {
...
def verify_preflight_manifest(
    ...
    if manifest["run_id"] != RUN_ID or manifest["implementation_version"] != "v5_prospective":
...
def verify_payload_review(
    ...
    if body["run_id"] != RUN_ID or body["implementation_version"] != "v5_prospective":
