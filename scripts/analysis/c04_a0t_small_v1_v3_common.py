...
SCHEMA_VERSION = "c04_a0t_small_v1_impl_v3"
...
ARTIFACT_ROOT = Path("artifacts/c04/a0t_small_v1_impl_v3")
CONFIG_RELATIVE = "configs/c04/c04_a0t_small_v1_v3.json"
TRAIN_ASR_RELATIVE = {
...
def verify_preflight_manifest(
    ...
    if manifest["run_id"] != RUN_ID or manifest["implementation_version"] != "v3_prospective":
