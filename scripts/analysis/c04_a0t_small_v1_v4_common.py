...
SCHEMA_VERSION = "c04_a0t_small_v1_impl_v4"
...
ARTIFACT_ROOT = Path("artifacts/c04/a0t_small_v1_impl_v4")
CONFIG_RELATIVE = "configs/c04/c04_a0t_small_v1_v4.json"
TRAIN_ASR_RELATIVE = {
...
def verify_preflight_manifest(
    ...
    if manifest["run_id"] != RUN_ID or manifest["implementation_version"] != "v4_prospective":
...
def verify_payload_review(
    ...
    if body["run_id"] != RUN_ID or body["implementation_version"] != "v4_prospective":
