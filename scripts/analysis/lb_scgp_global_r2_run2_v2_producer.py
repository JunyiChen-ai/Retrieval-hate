...
def verify_config_and_schema(cfg: dict[str, Any]) -> None:
    ...
    assert_equal(cfg["run"]["artifact_path"], "artifacts/lb_scgp_global/v2/m0/synth_kkt/manifest.json", "artifact path")
...
def main() -> int:
    ...
    manifest: dict[str, Any] = {
        "schema_version": "lb_scgp_global_r2_synth_kkt_manifest_v2",
