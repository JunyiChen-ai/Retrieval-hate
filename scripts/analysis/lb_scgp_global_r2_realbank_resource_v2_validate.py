...
def main() -> int:
    ...
    result = {
        "schema_version": "lb_scgp_global_r2_realbank_resource_validation_v2",
        "run_id": args.run_id,
        "status": status,
        "checks": checks,
        "validator_sha256": sha256_file("scripts/analysis/lb_scgp_global_r2_realbank_resource_v2_validate.py"),
