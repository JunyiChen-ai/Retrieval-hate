...
class AccessAudit:
    ...
    def snapshot(self) -> dict[str, Any]:
        return {
            "schema_version": "c04_guarded_access_audit_v7",
...
def publish_budget_breach_record(
    ...
    """
    record = {
        "schema_version": "c04_budget_breach_v7",
        "run_id": RUN_ID,
        ...
        "frame_packs_created_this_invocation": frame_packs_created,
...
def strict_validate_frame_pack(
    ...
    assert_equal(manifest["schema_version"], "c04_frame_pack_manifest_v7", "frame schema")
...
def load_or_create_frame_pack(
    ...
    try:
        ...
        manifest = {
            "schema_version": "c04_frame_pack_manifest_v7",
            **expected_binding,
...
def canonicalize_dataset(
    ...
    applicability_payload = {
        "schema_version": "c04_fallback_applicability_v7",
        "run_id": RUN_ID,
        "dataset": dataset,
...
def idempotent_complete(
    ...
    assert_equal(manifest["implementation_version"], "v7_prospective", "seal implementation")
...
def main() -> int:
    ...
    access = {
        "schema_version": "c04_access_ledger_v7",
        "run_id": RUN_ID,
        "implementation_version": "v7_prospective",
    ...
    seal = {
        "schema_version": "c04_a0t_small_seal_manifest_v7",
        "run_id": RUN_ID,
        "implementation_version": "v7_prospective",
        "lineage": lineage,
