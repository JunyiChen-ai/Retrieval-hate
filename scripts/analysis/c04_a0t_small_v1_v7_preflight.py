...
from c04_a0t_small_v1_v7_gpu_ledger import (  # noqa: E402
    GPU_LEDGER_KEYS,
...
def verify_static_config(cfg: dict[str, Any]) -> str:
    ...
    assert_equal(cfg["schema_version"], "c04_a0t_small_v1_v7_config_v1", "config schema")
...
def verify_code_resource_authorization(cfg: dict[str, Any]) -> tuple[dict[str, Any], str]:
    ...
    assert_equal(body["implementation_version"], "v7_prospective", "code/resource implementation")
...
def run_self_tests(cfg: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema_version": "c04_a0t_small_v1_impl_v7_self_test_v1",
        "run_id": RUN_ID,
        "checks": checks,
        "all_passed": True,
    }
...
def preflight(cfg: dict[str, Any], prompt_hash_binding: str) -> None:
    ...
    gpu_ledger = {
        "schema_version": "c04_gpu_ledger_v7",
        "run_id": RUN_ID,
    ...
    ticket = {
        "schema_version": "c04_resource_ticket_v7",
        "run_id": RUN_ID,
        "implementation_version": "v7_prospective",
        "single_use": True,
        "consumed": False,
    ...
    preflight_manifest = {
        "schema_version": "c04_a0t_small_preflight_manifest_v7",
        "run_id": RUN_ID,
        "implementation_version": "v7_prospective",
