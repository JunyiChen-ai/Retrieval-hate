...
SCHEMA_ID = "scgp_global_synth_kkt_payload_v2"
TRI_OBSERVABLES = (
...
def verify_declared_paths(manifest: dict[str, Any], config: dict[str, Any]) -> None:
    expected_paths = {
        "config_path": "configs/lb_scgp_global_r2/m0_synth_kkt_v2.json",
...
def verify_top_level_hashes(
    ...
    if verify_files:
        if manifest["hashes"]["config_sha256"] != sha256_file(root_path("configs/lb_scgp_global_r2/m0_synth_kkt_v2.json")):
...
def main() -> int:
    ...
    try:
        ...
        decision = {
            "schema_version": "lb_scgp_global_r2_run2_v2_semantic_verification_v1",
            "run_id": RUN2,
            "decision": "PASS",
