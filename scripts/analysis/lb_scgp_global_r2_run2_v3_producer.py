...
from lb_scgp_global_r2_run2_v3_common import (  # noqa: E402
    PAYLOAD_SCHEMA_ID,
    RUN2,
    AccessLedger,
    assert_equal,
...
def verify_config_and_schema(cfg: dict[str, Any]) -> None:
    ...
    assert_equal(cfg["run"]["artifact_path"], "artifacts/lb_scgp_global/v3/m0/synth_kkt/manifest.json", "artifact path")
...
def main() -> int:
    ...
    manifest: dict[str, Any] = {
        "schema_version": "lb_scgp_global_r2_synth_kkt_manifest_v3",
