...
from c04_a0t_small_v1_v5_common import (  # noqa: E402
    ADDITIVE_INPUT_DIM,
    ARTIFACT_ROOT,
    CONFIG_RELATIVE,
    DATASETS,
...
class AccessAudit:
    ...
    def snapshot(self) -> dict[str, Any]:
        return {
            "schema_version": "c04_guarded_access_audit_v5",
...
def verify_authorization(cfg: dict[str, Any]) -> None:
    ...
    assert_equal(cfg["run"]["implementation_version"], "v5_prospective", "implementation")
...
def expected_frame_pack_binding(
    ...
    return {
        "run_id": RUN_ID,
        "implementation_version": "v5_prospective",
        "dataset": dataset,
...
def strict_validate_frame_pack(
    ...
    assert_equal(manifest["schema_version"], "c04_frame_pack_manifest_v5", "frame schema")
...
def load_or_create_frame_pack(
    ...
    try:
        ...
        manifest = {
            "schema_version": "c04_frame_pack_manifest_v5",
            **expected_binding,
...
def canonicalize_dataset(
    ...
    applicability_payload = {
        "schema_version": "c04_fallback_applicability_v5",
        "run_id": RUN_ID,
        "dataset": dataset,
    ...
    for prepared_row in prepared:
        ...
        record = {
            "schema_version": "c04_a0t_small_canonical_record_v5",
            "run_id": RUN_ID,
            "dataset": dataset,
            "video_id": video_id,
...
def idempotent_complete(
    ...
    assert_equal(manifest["implementation_version"], "v5_prospective", "seal implementation")
...
def main() -> int:
    ...
    for dataset in DATASETS:
        ...
        for rank, input_row in enumerate(inputs[dataset]):
            ...
            for prompt_form in PROMPT_FORMS:
                ...
                record = {
                    "schema_version": "c04_a0t_small_prompt_record_v5",
                    "run_id": RUN_ID,
                    "dataset": dataset,
                    "video_id": video_id,
    ...
    access = {
        "schema_version": "c04_access_ledger_v5",
        "run_id": RUN_ID,
        "implementation_version": "v5_prospective",
    ...
    provisional = {
        "schema_version": "c04_provisional_gpu_usage_v5",
        "run_id": RUN_ID,
        "implementation_version": "v5_prospective",
        "lineage": lineage,
    ...
    seal = {
        "schema_version": "c04_a0t_small_seal_manifest_v5",
        "run_id": RUN_ID,
        "implementation_version": "v5_prospective",
        "lineage": lineage,
