...
ALLOW='^(data|miniconda3|Retrieval-hate|snap|venvs|Hate-follow-up|AgentDebugX|Auto-claude-code-research-in-sleep|miniconda\.sh|Miniconda3-latest-Linux-x86_64\.sh)$'
