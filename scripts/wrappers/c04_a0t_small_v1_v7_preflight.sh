...
readonly PREFLIGHT_SCRIPT=scripts/analysis/c04_a0t_small_v1_v7_preflight.py
...
echo "C04 impl-v7 CPU preflight complete; GPU remains blocked pending payload/GPU GO."
