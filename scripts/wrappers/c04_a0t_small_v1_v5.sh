...
readonly CONFIG=configs/c04/c04_a0t_small_v1_v5.json
readonly PYTHON_BIN=/data/jehc223/miniconda3/envs/HateVideo/bin/python
readonly LEDGER_SCRIPT=scripts/analysis/c04_a0t_small_v1_v5_gpu_ledger.py
readonly PRODUCER_SCRIPT=scripts/analysis/c04_a0t_small_v1_v5_producer.py
readonly LOCK_PATH=artifacts/c04/a0t_small_v1_impl_v5/resource/serial_gpu.lock
...
readonly ENTRY_MARKER=artifacts/c04/a0t_small_v1_impl_v5/resource/allocation_entry_marker.json
...
readonly SEAL=artifacts/c04/a0t_small_v1_impl_v5/seal/seal_manifest.json
jq -e '
  .terminal_state == "SEALED_PRELABEL_RELIABILITY_PASS"
  or .terminal_state == "KILL_C04_TEACHER_SEMANTIC_RELIABILITY"
' "$SEAL" >/dev/null
echo "C04 impl-v5 pre-label seal complete; terminal CPU sacct reconciliation is still required."
