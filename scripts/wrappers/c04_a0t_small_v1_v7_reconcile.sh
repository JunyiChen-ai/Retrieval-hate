...
readonly GPU_LEDGER=artifacts/c04/a0t_small_v1_impl_v7/resource/gpu_ledger.json
readonly FINAL_STATE=artifacts/c04/a0t_small_v1_impl_v7/resource/resource_final_state.json
...
echo "C04 impl-v7 terminal sacct reconciliation complete; no GPU/submit/chain performed."
