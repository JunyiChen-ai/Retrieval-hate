...
jq -e '
  ...
  and .run.implementation_version == "v5_prospective"
...
readonly GPU_LEDGER=artifacts/c04/a0t_small_v1_impl_v5/resource/gpu_ledger.json
readonly FINAL_STATE=artifacts/c04/a0t_small_v1_impl_v5/resource/resource_final_state.json
set +e
...
echo "C04 impl-v5 terminal sacct reconciliation complete; no GPU/submit/chain performed."
