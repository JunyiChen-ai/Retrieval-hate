...
readonly PREFLIGHT_SCRIPT=scripts/analysis/c04_a0t_small_v1_v5_preflight.py
...
echo "C04 impl-v5 CPU preflight complete; GPU remains blocked pending payload/GPU GO."
