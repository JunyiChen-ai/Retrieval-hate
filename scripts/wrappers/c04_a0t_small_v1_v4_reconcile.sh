...
jq -e '
  ...
  and .run.implementation_version == "v4_prospective"
...
readonly GPU_LEDGER=artifacts/c04/a0t_small_v1_impl_v4/resource/gpu_ledger.json
readonly FINAL_STATE=artifacts/c04/a0t_small_v1_impl_v4/resource/resource_final_state.json
set +e
...
echo "C04 impl-v4 terminal sacct reconciliation complete; no GPU/submit/chain performed."
