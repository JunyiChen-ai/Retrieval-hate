...
for corpus in hatemm hateclipseg; do
  for arm in anchor broadcast core branch_selector shuffled_carrier abstain_negative nonpositive_background projection_only; do
...
"$python" "$exp/summarize.py" --root "$root"
