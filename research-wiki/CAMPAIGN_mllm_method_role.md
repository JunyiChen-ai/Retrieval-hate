...
exhaustively refuted**: across **eleven pre-registered routes at 7B–72B scale**
(P1/P2/P2b/P3-EN,ZH,HateMM/P4/P5, plus P9/P9b the **decision level** and its rgcl-ON wave, and P10
the localization amplifier) no MLLM component lifts static test accuracy beyond the ~1.6-video
(≈1 acc pt) noise floor, and every verdict is guard-backed (reproduction / bit-for-bit / probe).
**Endgame tally (2026-07-08):** of the eleven main-table-accuracy routes **ten are dead** (kill /
within-noise) and **one — P10-b (the P6 localization amplifier) — is in flight**; the roles the MLLM
actually earned are **encoder + P6 localizer + guard-rail/audit** (§4). **P9 closes the last
architectural locus**: even LoRA-SFT-ing
